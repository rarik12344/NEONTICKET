export const CONFIG = {
  ...
  CURRENCY_SYMBOL: 'ETH',
  DEFAULT_GAS_PRICE: 0.2,
  GAS_LIMIT_BUFFER: 1.2,
  DEFAULT_GAS_LIMIT: 200000,
  ETH_PRICE_USD: 3000,
  FRAME_VERSION: 'next',
  FRAME_IMAGE_URL: 'https://i.ibb.co/HfcPqDfC/ogneon.jpg',
  SPLASH_IMAGE_URL: 'https://i.ibb.co/hJdsnrjV/splashscreen.jpg',
  SPLASH_BG_COLOR: '#0f0f1a'
};
...
export type LotteryContractABI = typeof ABI;
